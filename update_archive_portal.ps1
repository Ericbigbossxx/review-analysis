...
<header><div class="head"><div><h1>Review Analysis Archive</h1><div class="sub">长期存档页：每次分析保存为独立报告，可按日期、类型和平台筛选，并用于双周周会对比。</div></div><a class="latest" href="$latest">打开最新报告</a></div><div class="filters"><input id="q" placeholder="搜索日期/标题/SKU/主题"><select id="type"><option value="">全部类型</option><option value="biweekly">双周周会</option><option value="weekly">周度周会</option><option value="ad_hoc">日常分析</option></select><select id="platform"><option value="">全部平台</option>$platformOptions</select></div></header>
